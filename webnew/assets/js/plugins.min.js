(function(e) {
    jQuery.fn.equalHeightColumns = function(t, n) {
        function o(o) {
            ...
            var r = 0;
            o.each(function(t) {
                if (e(this).outerHeight() > a && (i = e(this), a = e(this).outerHeight()), ++r, r >= newCount || t == o.length - 1) {
                    var n = t - (r - 1);
                    e(o).slice(n, t + 1).css({
                        height: a + "px"
                    }), a = 0, r = 0
        ...
        var i = this;
        return t = t ? t : i.length, void 0 == n && (n = function() {
            return t
        }), o(this), e(window).on("resize.equalHeightColumns", function() {
            o(i)
        }), this.each(function() {
            return !0
        })
...
$.fn.dxInview = function(options) {
    var defaults = { in : function() {}, out: function() {}
    };
            ...
            var ModalVideo = function() {
                ...
                _createClass(ModalVideo, [{
                    ...
                    value: function getMP4Url(videoId) {
                        var videoHtml = "";
                        videoHtml += '<video controls autoplay class="inmodal-video">';
