	...
	if ($orderForm.length) {
		$orderForm.validate({
			...
			messages: {
				...
				appx_qty: {
					required: "Please Enter Garment Qty or Weight",
	...
	$window.on('load', function () {
		...
		function createMap(id, mapZoom) {
			...
			var mapOptions = {
				...
				center: new google.maps.LatLng(18.980492067336236, 73.13551833326801), // Glasgow
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(18.980492067336236, 73.13551833326801),
				map: map,
				icon: image
			});
